...
public class Entity : MonoBehaviour
{
    ...
    public delegate void ItemEventHandler(Entity entity, Item item);
    public event ItemEventHandler OnHitItem;
    ...
    private void Update()
    {
        if (isMoving)
        {
            ...
            {
                isMoving = false;
                OnHitItem?.Invoke(this, FindClosestItem());
            }
        }
    }
